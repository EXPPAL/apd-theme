...
<p class="shop-header-desc" style="display:none;">THE SHOP is a rewards based marketplace where you can earn rewards on every DEAL and SHOP purchase you make. Use earned rewards money to receive deeper discounts on products stocked in THE SHOP. <a href="https://audioplugin.deals/my-account/">Login</a> now to check out your rewards balance.
		<button class="btn-open-video" style="background:transparent;border-color:transparent;color:yellow;font-weight:bold;">LEARN MORE</button></p>
<section class="video-popup">
        <div class="wrapper-video">
            <div class="action-holder">
                <button data-action="open-short-video">Play short video (0:53)</button>
                ...
                <ul>
					<?php while ( $wc_query->have_posts() ) : $wc_query->the_post(); ?>
                        ...
                        <li class="grid-item">
							...
							?>
                            <a href="<?php echo $link; ?>" class="img-holder"><img
                                        src="<?php echo $full_size_image[0]; ?>" alt=""></a>
                            <div class="item-content">
                                ...
                                <div class="item-details <?php echo ( ! $product->get_sale_price() ) ? 'one-price' : '' ?>">
                                    ...
                                    <div class="action-holder">
                                        ...
                                        <!-- span class="sublabel">base price<mark class="base_price"><?php echo get_post_meta( get_the_ID(), '_minumum_price', true ); ?></mark></span -->
