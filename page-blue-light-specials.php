...
<section class="subhero-ribbon">
	...
	<p class="shop-header-desc" style="display:none;">THE SHOP is a rewards based marketplace where you can earn rewards on every DEAL and SHOP purchase you make. Use earned rewards money to receive deeper discounts on products stocked in THE SHOP.
		<a href="https://audioplugin.deals/my-account/">Login</a> now to check out your rewards balance.
		<button class="btn-open-video" style="background:transparent;border-color:transparent;color:yellow;font-weight:bold;">LEARN MORE</button>
	</p>
	<section class="video-popup">
		<div class="wrapper-video">
			<div class="action-holder">
