...
Container::make('post_meta', 'Page Content')
	->where('post_template', '=', 'page-templates/black-friday-2022.php')
	->add_fields(array(
		...
		Field::make('complex', 'new_deals', 'Deals')
		...
		Field::make('image', 'bottom_img', 'Bottom Image'),
		Field::make('association', 'product_id', 'Bottom Product')
					->set_min(1)
					->set_max(1)
					->set_types(array(
						array(
