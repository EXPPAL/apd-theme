...
<?php if ( is_home() ) : ?><h1 style="color:#D7BD2F;font-size:2.5em;font-weight:bold;text-align:left;"> The Blog</h1> <?php endif; ?>
...
<?php if ( is_home() ) { ?>
	<div class='sidebar' id='sidebar-wrapper'><?php get_sidebar('home'); ?></div>
